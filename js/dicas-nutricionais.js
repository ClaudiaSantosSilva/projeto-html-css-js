const dicasNutricionaisSection = document.querySelector(
  "#dicas-nutricionais-section"
);
const dicasNutricionaisList = document.querySelector(
  "#dicas-nutricionais-list"
);
...
let dicasNutricionais = [
  {
    ...
    texto:
      "Consuma fruta cítrica durante o almoço e o jantar (suco) ou como sobremesa. Evite bebidas como mate, coca-cola e café durante essas refeiçoes.",
  },

  {
    ...
    texto:
      "Ao contrário do que muitos dizem, a beterraba não tem açúcar (como aquele usado nas bebidas). Ela pode e deve ser usada como parte de uma alimentação variada e saudável.",
  },

  {
    ...
    texto:
      "Para que a perda de peso seja saudável e duradoura, a alimentação e o exercicio devem fazer parte da rotina diária, de forma consciente.",
  },
];
...
function getDicaItem(createdAt, imageSrc, titulo, texto) {
  ...
  dicasNutricionaisListItemInfoContent.className =
    "dicas-nutricionais-list-item-info-content";

  let dicasNutricionaisListItemCreatedAt = document.createElement("span");
  dicasNutricionaisListItemCreatedAt.className =
    "dicas-nutricionais-list-item-created-at";
  dicasNutricionaisListItemCreatedAt.innerHTML = createdAt;

  let dicasNutricionaisListItemImageSrc = document.createElement("img");
  dicasNutricionaisListItemImageSrc.className =
    "dicas-nutricionais-list-item-image-src";
  dicasNutricionaisListItemImageSrc.src = imageSrc;

  let dicasNutricionaisListItemTitulo = document.createElement("h3");
  dicasNutricionaisListItemTitulo.className =
    "dicas-nutricionais-list-item-titulo";
  dicasNutricionaisListItemTitulo.innerHTML = titulo;

  let dicasNutricionaisListItemTexto = document.createElement("p");
  dicasNutricionaisListItemTexto.className =
    "dicas-nutricionais-list-item-texto";
  ...
  dicasNutricionaisListItemInfoContent.appendChild(
    dicasNutricionaisListItemCreatedAt
  );
  dicasNutricionaisListItemInfo.appendChild(
    dicasNutricionaisListItemInfoContent
  );
...
const dicasNutricionaisListItemTitulo = document.querySelectorAll(
  ".dicas-nutricionais-list-item-titulo"
);
